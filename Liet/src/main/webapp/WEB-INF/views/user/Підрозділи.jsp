	...
	<div class="row border">
		<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
			<div class="text">
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
						<a href="/AGV"> <img src="/resources/image/image3.png" class="picture3"> <br>Адміністративно<br>господарський<br> відділ
						</a>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
						<a href="/VPN"> <img src="/resources/image/image4.png" class="picture3"> <br>Відділ <br>практичного <br>навчання
						</a>
					</div>
				</div>
			</div>
