...
<body>
	<div class="container">
		...
		<form:form action="/admin/internshipPicture" method="post" class="form-inline" modelAttribute="form" enctype="multipart/form-data">
			<form:hidden path="id" />
			<div class="form-group">
				<form:select path="internship" items="${internships}" itemLabel="name"
							itemValue="id">
						</form:select><br>
